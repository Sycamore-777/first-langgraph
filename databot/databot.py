...
def fig_inter(py_code: str, fname: str) -> str:
    ...
    # ✅ 设置图像保存路径（你自己的绝对路径）
    base_dir = r"D:\Program\github\opensource\agent-chat-ui\public"
...
# ✅ 创建模型
model = ChatDeepSeek(model="deepseek-chat", api_base=os.getenv("BASE_URL"),api_key=os.getenv("API_KEY"))
